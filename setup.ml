...
(* OASIS_START *)
(* DO NOT EDIT (digest: c4133500dbfaa67626e1a9bfc681656f) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["John Else"];
          homepage = None;
          synopsis = "Ocaml C bindings experiments";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.0";
     oasis_digest = Some "0N\026\020UY#\242\145=\r\160\178S\211\217";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
